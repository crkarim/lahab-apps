        ...
        <footer class="footer py-3 mt-4">
            <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 align-items-center">
                ...
                <p class="copyright-text mb-0">
                    © {{ date('Y') }} | {{ translate('All Rights Reserved') }}
                    &nbsp;·&nbsp;
                    <a href="mailto:rka.mahedi@gmail.com" style="color:inherit;text-decoration:underline;">{{ translate('Support') }}: Mahedi · rka.mahedi@gmail.com · 0162001075</a>
                </p>
            </div>
        </footer>
    </div>
