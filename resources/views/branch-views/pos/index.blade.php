                ...
                <div class="row gy-3 gx-2">
                    ...
                    <div class="col-lg-5">
                        <div class="card h-100 rounded">
                            <div class="billing-section-wrap brnch-p overflow-hidden">
                                <div class="pos-title">
                                    <h4 class="mb-0 fs-16 text-title font-weight-normal">{{translate('Billing_Section')}}</h4>
                                </div>

                                <div class="p-2 p-sm-4 overflow-y-auto billing-section-wrap brnch-p">
                                    ...
                                    <div class="bg-color4 rounded p-10px mb-20">
                                        ...
                                        <div class="d-none mt-2" id="dine_in_section">
                                        ...
                                        <div class="form-group mb-0 mt-2 card rounded border pt-2 pb-2 px-3 d-none" id="home_delivery_section">
                                            <div class="d-flex justify-content-between">
                                                <label for="" class="font-weight-semibold mb-0 fz-16 text-dark">
                                                    <i class="tio-user-big fs-14"></i>
                                ...
                                <div class="row pl-2">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control" value="" placeholder="{{translate('Ex : +88017*****')}}"
        ...
        <div class="modal fade" id="edit-customer" tabindex="-1">
            <div class="modal-dialog madl--lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('branch.pos.customer.update')}}" method="post" id="customer-edit-form">
                            @csrf
                            <div class="bg-color4 rounded p-3">
                                ...
                                <div class="row pl-2">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control" value="" placeholder="{{translate('Ex : +88017*****')}}" required=""
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchAndShowCustomerCard(id) {
            ...
            $.ajax({
                url: '{{ route("branch.pos.get-customer-details") }}',
                type: 'GET',
                data: { id: id },
        ...
        $('.customer').change(function() {
            ...
            $.post({
                url: '{{ route('branch.pos.change-customer') }}',
                data: {
                    _token: '{{ csrf_token() }}',
   ...
   $(function(){
    ...
    $(document).on('click', '.open-coupon-modal', function () {
        ...
        $.get("{{ route('branch.pos.coupon.list') }}", {
            amount: totalAmount
        }, function (response) {
    ...
    $(document).on('click', '#confirm-remove-btn', function () {
        $.ajax({
            url: '{{ route("branch.pos.coupon.remove") }}',
            type: 'GET',
            success: function(data) {
