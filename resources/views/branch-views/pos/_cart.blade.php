    ...
    <div class="bg-white rounded overflow-hidden">
        ...
        <div class="pos-data-table p-3">
            <dl class="row">
                ...
                <dd class="col-6 text-right">{{Helpers::set_symbol($productSubtotal+$addonPrice) }}</dd>
                ...
                <dd class="col-6 text-right text-c2 text-nowrap">
                    ...
                    @endif
                    <button class="btn btn-sm p-0 text-c2 open-coupon-modal" type="button" data-toggle="modal" data-target="#add-coupon-discount">
                        <i class="tio-edit"></i>
                    </button>
                ...
                <dd class="col-6 text-right text-c2">
                    <button class="btn btn-sm p-0 text-c2" type="button" data-toggle="modal" data-target="#add-discount">
                        <i class="tio-edit"></i>
                    </button>
                ...
                @php $totalProductAndAddonPriceAfterDiscount = $subtotal+$addonPrice-$discountAmount; @endphp
                @php $totalOrderAmount = $total+$totalTax+$addonTotalTax+$deliveryCharge; @endphp
...
<div class="modal fade" id="add-coupon-discount" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered madl--lg">
        <div class="modal-content apply-coupon-modal">
            ...
            <form action="{{route('branch.pos.coupon.apply')}}" method="post">
                @csrf
