                ...
                <div class="row align-items-md-center g-3">
                    ...
                    <div class="col-md-7">
                        ...
                        @php
                            ...
                            $total=$deliveryman->reviews->count();

                        @endphp
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $five=\App\CentralLogics\Helpers::dm_rating_count($deliveryman['id'],5);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $four=\App\CentralLogics\Helpers::dm_rating_count($deliveryman['id'],4);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $three=\App\CentralLogics\Helpers::dm_rating_count($deliveryman['id'],3);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $two=\App\CentralLogics\Helpers::dm_rating_count($deliveryman['id'],2);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $one=\App\CentralLogics\Helpers::dm_rating_count($deliveryman['id'],1);
                                @endphp
