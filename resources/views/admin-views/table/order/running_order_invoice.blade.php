                ...
                @endphp
                    ...
                    <table class="table table-bordered mt-3">
                        ...
                        @foreach($order->details as $detail)
                            @if($detail->product)
                                @php
                                    $addonQuantities=json_decode($detail['add_on_qtys'],true);
                                @endphp
                                @php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @foreach(json_decode($detail['add_on_ids'],true) as $key2 =>$id)
                                            ...
                                            @php
                                                $addonCost+=$addonPrices[$key2] * $addonQty;
                                            @endphp
                                            @php
                                                $addonTaxCost +=  $addonTaxes[$key2] * $addonQty;
                                            @endphp
                                        @endforeach
