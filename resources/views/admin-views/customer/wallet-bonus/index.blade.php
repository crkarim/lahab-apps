                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="{{ translate('Ex:_EID_Dhamaka') }}" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ translate('Short Description') }}</label>
                                        <input type="text" name="description" class="form-control" value="{{ old('description') }}" placeholder="{{ translate('Ex:_EID_Dhamaka') }}" tabindex="2">
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="bonus_type" class="form-control" id="bonus_type" tabindex="3" required>
                                            <option value="percentage" {{ old('bonus_type') == 'percentage' ? 'selected' : '' }}>{{translate('percentage')}} (%)</option>
                                            <option value="amount" {{ old('bonus_type') == 'amount' ? 'selected' : '' }}>{{translate('amount')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99" name="bonus_amount" value="{{ old('bonus_amount') }}"  placeholder="{{ translate('Ex:_100') }}"
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99" name="minimum_add_amount" value="{{ old('minimum_add_amount') }}" placeholder="{{ translate('Ex:_10') }}"
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6" id="maximum_bonus_amount_div">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99" name="maximum_bonus_amount" value="{{ old('maximum_bonus_amount') }}" placeholder="{{ translate('Ex:_1000') }}"
                                               id="maximum_bonus_amount" class="form-control" tabindex="6" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
