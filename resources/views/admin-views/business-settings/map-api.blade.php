                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.third-party.map_api_settings'):'javascript:'}}" method="post"
                            ...
                            <div class="row">
                                @php
                                    $serverKey=\App\Model\BusinessSetting::where('key','map_api_server_key')->first()?->value ;
                                @endphp
                                ...
                                @php
                                    $clientKey=\App\Model\BusinessSetting::where('key','map_api_client_key')->first()?->value;
                                @endphp
                                <div class="form-group col-md-6">
