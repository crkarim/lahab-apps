    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php $mail_status=\App\Model\BusinessSetting::where('key','registration_mail_status_dm')->first(); @endphp
                ...
                @php $data=\App\Models\EmailTemplate::where('type','dm')->where('email_type', 'registration')->first(); @endphp
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php $data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->with('translations')->where('type','dm')->where('email_type', 'registration')->first(); @endphp
