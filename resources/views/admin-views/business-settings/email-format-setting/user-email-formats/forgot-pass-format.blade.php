    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php
                        $mail_status=\App\Model\BusinessSetting::where('key','forget_password_mail_status_user')->first();
                    @endphp
                    @php
                ...
                @php
                    $data=\App\Models\EmailTemplate::where('type','user')->where('email_type', 'forget_password')->first();
                @endphp
                @php
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php
                                            $data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->with('translations')->where('type','user')->where('email_type', 'forget_password')->first();
                                        @endphp
                                        @php
