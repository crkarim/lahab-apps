                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="border rounded p-4 mb-20">
                                        <div class="mb-3">
                                            <h4 class="mb-0 text-center">{{ translate('branch_Image') }} </h4>
                                        </div>
                                        <div class="text-center">
                                            <div class="upload-file_custom ratio-1 h-100px mx-auto">
                                                ...
                                                <label class="upload-file__wrapper w-100 h-100 m-0">
                                                    ...
                                                    <img class="upload-file-img" loading="lazy" src="{{$branch->imageFullPath}}"
                                    ...
                                    <div class="border rounded p-4">
                                        <div class="mb-3">
                                            <h4 class="mb-0 text-center">{{ translate('branch_cover_image') }} </h4>
                                        </div>
                                        <div class="text-center">
                                            <div class="upload-file_custom ratio-3-1 h-100px mx-auto">
                                                ...
                                                <label class="upload-file__wrapper w-100 h-100 m-0">
                                                    ...
                                                    <img class="upload-file-img" loading="lazy" src="{{$branch->coverImageFullPath}}"
                                                            data-default-src="" alt="" style="display: none;">
                                                </label>
                                                <div class="overlay-review">
                                                    <div
