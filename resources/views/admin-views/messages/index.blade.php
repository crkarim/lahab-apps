...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{asset('public/assets/admin/vendor/lightbox2/css/lightbox.css')}}">
@endpush
                    ...
                    <div class="py-4" id="conversation_sidebar">
                        ...
                        @foreach($conversations as $conv)
                            @if(in_array($conv->user_id,$array)==false)
                                ...
                                @php
                                    $unchecked=\App\Model\Conversation::where(['user_id'=>$conv->user_id,'checked'=>0])->count();
                                @endphp
                                @if(isset($user))
...
@endsection
@push('script_2')
    <script src="{{asset('public/assets/admin/vendor/lightbox2/js/lightbox.js')}}"></script>
