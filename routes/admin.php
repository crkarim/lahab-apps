...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
            ...
            Route::post('coupon/apply', [POSController::class, 'couponApply'])->name('coupon.apply');
            ...
            Route::get('customer-details', [POSController::class, 'getCustomerDetails'])->name('get-customer-details');
            Route::post('customer-update', [POSController::class, 'updateCustomer'])->name('customer.update');
            Route::get('coupon/list', [POSController::class, 'couponList'])->name('coupon.list');
            Route::get('coupon/remove', [POSController::class, 'removeCoupon'])->name('coupon.remove');
            Route::post('change-customer', [POSController::class, 'changeCustomer'])->name('change-customer');
