...
class BranchPromotionController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($request->image) {
            $promotion->promotion_name = Helpers::upload('promotion/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
        }
        $promotion->save();
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        if ($request->image) {
            $promotion->promotion_name = $request->has('image') ? Helpers::update('promotion/', $promotion->image, APPLICATION_IMAGE_FORMAT, $request->file('image')) : $promotion->image;
