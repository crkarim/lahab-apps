...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (!empty($request->file('identity_image'))) {
            foreach ($request->identity_image as $img) {
                $identityImageNames[] = Helpers::upload('delivery-man/', APPLICATION_IMAGE_FORMAT, $img);
            }
        ...
        $deliveryman->image = Helpers::upload('delivery-man/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        if (!empty($request->file('identity_image'))) {
            ...
            $imgKeeper = [];
            foreach ($request->identity_image as $img) {
                $imgKeeper[] = Helpers::upload('delivery-man/', APPLICATION_IMAGE_FORMAT, $img);
            }
        ...
        $deliveryman->branch_id = $request->branch_id;
        $deliveryman->identity_image = $identityImage;
        $deliveryman->image = $request->has('image') ? Helpers::update('delivery-man/', $deliveryman->image, APPLICATION_IMAGE_FORMAT, $request->file('image')) : $deliveryman->image;
