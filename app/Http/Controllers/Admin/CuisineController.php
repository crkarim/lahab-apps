...
class CuisineController extends Controller
{
    ...
    function store(Request $request): RedirectResponse
    {
        ...
        if (!empty($request->file('image'))) {
            $imageName = Helpers::upload('cuisine/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
        } else {
            $imageName = 'def.png';
        }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        $cuisine->name = $request->name[array_search('en', $request->lang)];;
        $cuisine->sub_title = $request->sub_title[array_search('en', $request->lang)];
        $cuisine->image = $request->has('image') ? Helpers::update('cuisine/', $cuisine->image, APPLICATION_IMAGE_FORMAT, $request->file('image')) : $cuisine->image;
        $cuisine->save();
