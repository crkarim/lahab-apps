...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $product->image = Helpers::upload('product/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        $product->set_menu = $request->item_type;
        $product->product_type = $request->product_type;
        $product->image = $request->has('image') ? Helpers::update('product/', $product->image, APPLICATION_IMAGE_FORMAT, $request->file('image')) : $product->image;
        $product->available_time_starts = $request->available_time_starts;
        $product->available_time_ends = $request->available_time_ends;
