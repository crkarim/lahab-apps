...
class KitchenController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $chef->image = Helpers::upload('kitchen/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
            $chef->save();
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        try {
            ...
            $chef->image = $request->has('image') ? Helpers::update('kitchen/', $chef->image, APPLICATION_IMAGE_FORMAT, $request->file('image')) : $chef->image;
            $chef->update();
