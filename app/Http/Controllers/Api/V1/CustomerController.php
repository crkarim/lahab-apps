...
class CustomerController extends Controller
{
    ...
    public function updateProfile(Request $request): JsonResponse
    {
        ...
        $user->image = $request->has('image') ? Helpers::update('profile/', auth('api')->user()->imagee, APPLICATION_IMAGE_FORMAT, $request->file('image')) : auth('api')->user()->image;
    ...
    public function subscribeNewsletter(Request $request): JsonResponse
    {
        ...
        if (!isset($newsLetter)) {
            ...
            $errors = [];
            $errors[] = ['code' => 'email', 'message' => 'This email is already subscribed'];
