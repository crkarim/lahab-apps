...
--
-- Host: localhost:8889
-- Generation Time: Dec 18, 2025 at 03:52 AM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":null,\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":null,\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 1, NULL, '2025-12-18 02:49:00', NULL),
...
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2025-12-18 02:49:00'),
...
CREATE TABLE `orders` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` bigint DEFAULT NULL,
  `placed_by_admin_id` bigint UNSIGNED DEFAULT NULL,
  `is_guest` int NOT NULL DEFAULT '0',
  ...
  `receipt_token` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kot_number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kot_sent_at` timestamp NULL DEFAULT NULL,
  `kot_print_count` smallint UNSIGNED NOT NULL DEFAULT '0',
